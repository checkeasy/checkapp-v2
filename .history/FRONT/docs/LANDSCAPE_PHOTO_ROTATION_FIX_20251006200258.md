...
3. **Rotation is consistent** across:
   - Ghost overlay (reference photo overlay during capture)
   - Comparison view (side-by-side comparison after capture)
   - PhotoCarousel zoom modal (reference photo viewing)
