# 📱 Détection et Adaptation Automatique de l'Orientation
...
Système intelligent de détection et d'adaptation automatique de l'orientation des photos de référence dans le composant de capture photo. L'application guide l'utilisateur à orienter son téléphone correctement et adapte automatiquement l'interface selon l'orientation détectée.
...
2. **Guider l'utilisateur** avec une animation visuelle pour tourner son téléphone si nécessaire
3. **Adapter l'interface** automatiquement quand l'utilisateur tourne son téléphone
4. **Bloquer la capture** tant que l'orientation n'est pas correcte
5. **Basculer l'app en mode horizontal** automatiquement pour les photos paysage
...
**Rôle:** Composant d'animation qui s'affiche quand l'orientation de l'appareil ne correspond pas à celle de la photo de référence.

**Fonctionnalités:**
- Animation de rotation du téléphone (icône Smartphone qui tourne)
- Flèche de rotation animée autour du téléphone
- Message explicatif selon l'orientation requise
- Indicateur visuel de l'orientation (rectangle portrait/paysage)
...
**Affichage:**
- Se superpose en plein écran avec fond noir semi-transparent
- Disparaît automatiquement quand l'orientation est correcte
