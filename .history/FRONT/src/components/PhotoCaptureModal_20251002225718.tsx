...
export function PhotoCaptureModal({
  ...
  const [comparisonReferencePhoto, setComparisonReferencePhoto] = useState<string | null>(null); // ✅ AJOUTÉ: Photo de référence pour la comparaison
  ...
  const handleShowComparison = useCallback((referenceId: string) => {
    ...
    if (capturedPhoto && referencePhoto) {
      ...
      setComparisonReferencePhoto(referencePhoto.url); // ✅ AJOUTÉ: Stocker la photo de référence
