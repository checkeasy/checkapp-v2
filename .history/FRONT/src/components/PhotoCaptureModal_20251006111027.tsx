...
export function PhotoCaptureModal({
  ...
  const [ghostOpacity, setGhostOpacity] = useState(0.1); // 🎨 Opacité par défaut à 10%
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black">
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        >
          ...
          <video
            ...
            style={{
              ...
              // 🆕 Rotation supplémentaire de -90° pour le flux vidéo en mode paysage
              // Compense le fait que la caméra reste en mode portrait natif
              transform: isLandscapePhoto ? 'translate(-50%, -50%) rotate(-90deg)' : 'none'
            }}
          />
        ...
        {/* Contrôle d'opacité vertical - Position adaptée selon l'orientation */}
        <div
          className={`absolute z-10 transition-all duration-500 ${
            isLandscapePhoto
              ? 'left-4 top-1/2 -translate-y-1/2'  // À gauche pour paysage (bouton à droite)
        ...
        {/* Bouton de capture - Position adaptée selon l'orientation */}
        <div
          className={`absolute z-10 transition-all duration-500 ${
            isLandscapePhoto
              ? 'bottom-20 right-4'  // Au-dessus des miniatures à droite pour paysage
              : 'bottom-20 left-1/2 -translate-x-1/2'  // En bas au centre pour portrait
          }`}
        >
          <Button
