  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild>
        <Button
          variant="ghost"
          className="group h-auto px-3 sm:px-4 py-2.5 sm:py-3 text-sm font-medium text-foreground hover:text-primary transition-all duration-300 hover:scale-[1.02] bg-white/60 backdrop-blur-sm border border-white/40 rounded-lg shadow-card hover:shadow-elegant focus:ring-2 focus:ring-primary/20 max-w-[90vw] w-auto"
          onClick={handleSelectorOpen}
        >
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 overflow-hidden">
            <Typography variant="section-subtitle" className="font-semibold truncate max-w-[140px] xs:max-w-[180px] sm:max-w-[250px] md:max-w-[350px] lg:max-w-[400px]">
