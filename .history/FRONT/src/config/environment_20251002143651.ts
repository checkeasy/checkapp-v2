...
export const environment = {
  ...
  IMAGE_UPLOAD_URL: import.meta.env.VITE_IMAGE_UPLOAD_URL || 
    `${API_BASE_URL}/${BUBBLE_ENV}/api/1.1/wf/upload-image`,
  ...
  LOG_LEVEL: import.meta.env.VITE_LOG_LEVEL || (isDevelopment ? 'debug' : 'info'),
  ...
  CAMERA_FACING_MODE: import.meta.env.VITE_CAMERA_FACING_MODE || 'environment',
  ...
  INDEXEDDB_VERSION: parseInt(import.meta.env.VITE_INDEXEDDB_VERSION || '1', 10),
