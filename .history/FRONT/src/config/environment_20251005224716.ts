...
export const environment = {
  ...
  CAMERA_FACING_MODE: import.meta.env.VITE_CAMERA_FACING_MODE || 'user', // 📷 Caméra frontale par défaut
  ...
  INDEXEDDB_VERSION: parseInt(import.meta.env.VITE_INDEXEDDB_VERSION || '2', 10), // 🎯 FIX: Version 2 pour ajout index logementId
