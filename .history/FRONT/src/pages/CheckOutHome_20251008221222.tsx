...
export const CheckoutHome = () => {
  ...
  const handleStartCheckout = () => {
    ...
    // 🎯 FIX CRITIQUE: Utiliser navigatePreservingParams pour préserver parcours et checkid
  ...
  const handleOpenRapport = () => {
    if (checkSession?.rapportID) {
      const bubbleEnv = environment.BUBBLE_ENV; // 'test' ou 'live'
      const rapportUrl = `https://app.checkeasy.co/version-${bubbleEnv}/rapport/${checkSession.rapportID}`;
    ...
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        primaryAction={{
          ...
          disabled: flowState.isCompleted
        }}
        bottomText={{
