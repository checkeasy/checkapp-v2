    ...
    const loadSession = async () => {
      if (currentCheckId) {
        ...
        if (session) {
          ...
          // 🆕 Récupérer la session de check-in correspondante
          if (user?.id && session.parcoursId) {
            ...
            if (checkinSessionFound) {
              ...
              console.log('📋 Session check-in trouvée:', {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-md mx-auto px-4 space-y-3">
        ...
        {/* 🆕 Logique d'affichage des heures selon le type de parcours */}
        {/* Check d'entrée effectué - Afficher uniquement si checkInAndCheckOut ET état initial fait */}
        {takePicture === 'checkInAndCheckOut' && checkinSession && (
          ...
          <CardHeader className="py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-1">
                  <Typography variant="caption" className="text-green-600">
                    {/* 🆕 Afficher l'heure réelle si checkInAndCheckOut ET état initial fait, sinon heure prévue */}
                    {takePicture === 'checkInAndCheckOut' && checkinSession && checkSession?.completedAt ? (
