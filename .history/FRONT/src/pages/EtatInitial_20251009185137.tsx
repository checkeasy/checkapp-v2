...
export const EtatInitial = () => {
  ...
  const handleValidation = async () => {
    ...
    // 🎯 FIX: Récupérer les paramètres URL pour préserver parcours et checkid
    ...
    let targetPath = '/checkout-home';
    const queryParams: string[] = [];

    if (parcoursId) {
      queryParams.push(`parcours=${parcoursId}`);
    }
    if (checkId) {
      queryParams.push(`checkid=${checkId}`);
    }
