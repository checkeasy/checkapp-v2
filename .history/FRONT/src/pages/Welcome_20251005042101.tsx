...
const Welcome = () => {
  ...
  useEffect(() => {
    const restoreSessionFromUrl = async () => {
      ...
      try {
        ...
        // 3. Authentifier l'utilisateur avec les infos de la session
        login({
        ...
        console.log('✅ Welcome: Utilisateur authentifié depuis la session');
  ...
  const handleResumeSpecificSession = async (session: CheckSession) => {
    ...
    try {
      ...
      // 🎯 Navigation avec CheckID préservé
