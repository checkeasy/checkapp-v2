...
export class DataAdapter {
  ...
  private static createTaskFromEtape(
    ...
    // 3. IMPORTANT: Si todoParam est vide (""), la photo n'est PAS requise (simple checkbox)
    const hasPhotoRequirement = etape.todoParam && etape.todoParam.trim() !== '';
    const requiresPhoto = !!etape.todoImage || (hasPhotoRequirement && etape.todoParam === 'photoRequired');
