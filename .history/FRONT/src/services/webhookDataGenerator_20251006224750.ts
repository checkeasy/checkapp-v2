      ...
      if (photoArray && Array.isArray(photoArray)) {
        photoArray.forEach((photo: any) => {
          ...
          const photoEtape = {
            ...
            comment: '',
            photo_id: photo.photoId,
            // ✅ CORRECTION: Séparer base64 et URL
            photo_base64: isBase64 ? photoDataValue : null,  // Base64 uniquement si c'est une base64
            photo_url: isBase64 ? '' : photoDataValue,       // URL uniquement si ce n'est pas une base64
            validated: photo.validated || false,
            retake_count: photo.retakeCount || 0,
