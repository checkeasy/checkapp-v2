...
**User Preference**: No mirror effect at all
1. **Preview**: NOT mirrored (normal view)
2. **Captured Photo**: NOT mirrored (normal view)
3. **Consistency**: What you see is what you get

This differs from standard camera apps but provides better consistency between preview and captured photos.
