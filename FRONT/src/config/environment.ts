...
export const environment = {
  ...
  BLUR_DETECTION_ENABLED: import.meta.env.VITE_BLUR_DETECTION_ENABLED !== 'false', // Activé par défaut
  BLUR_THRESHOLD: parseInt(import.meta.env.VITE_BLUR_THRESHOLD || '250', 10), // Seuil de netteté (plus haut = moins sensible)
  BLUR_ANALYSIS_STEP: parseInt(import.meta.env.VITE_BLUR_ANALYSIS_STEP || '4', 10), // Analyser 1 pixel sur N
  BLUR_EDGE_MARGIN: parseInt(import.meta.env.VITE_BLUR_EDGE_MARGIN || '50', 10), // Ignorer les bords (pixels)
  BLUR_MIN_VARIANCE: parseInt(import.meta.env.VITE_BLUR_MIN_VARIANCE || '100', 10), // Variance minimale pour considérer comme net
...
if (environment.DEBUG_MODE) {
  console.log('🌍 Configuration de l\'environnement:', {
    ...
    isProduction,
    BUBBLE_ENV,
    PARCOURS_DATA_URL: environment.PARCOURS_DATA_URL,
