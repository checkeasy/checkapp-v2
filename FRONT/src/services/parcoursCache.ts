...
class ParcoursCache {
  ...
  /**
   * Alias pour removeParcours (pour compatibilité)
   */
  async clearCache(parcoursId: string): Promise<void> {
    return this.removeParcours(parcoursId);
  }
  ...
  /**
   * Alias pour clearAll (pour compatibilité avec logoutCleanupService)
   */
